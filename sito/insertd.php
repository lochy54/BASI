...
select persona.* from persona INNER join docente on docente.idpersona = persona.idpersona";
...
<div id="c1">     
  ...
  <tbody>
    ...
    <div id="c4" style="left:80.8%;">
<p><button type="submit" class="btn btn-primary">Crea docente</button></p>
    ...
    <div class="card mb-3"  style="left: 80%; top:18%;position:absolute;  ">
        ...
        <p><strong>Nome:</strong></p>
         ...
         <input type="hidden" name="cre" id="cre" value='0'>
