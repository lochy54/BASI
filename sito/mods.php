...
$sql1 = "
select persona.*, studente.matricola, studente.password from persona right join studente ON studente.idpersona = persona.idpersona  ";
...
<div class="card mb-3"  style="left:80%; top:18%;position:absolute;  ">
        ...
        <p><strong>Nome:</strong></p>
         ...
         <p><button type="submit" class="btn btn-primary">Modifica studente</button></p>
         <p><button type="submit" class="btn btn-primary" value="1" name="del" id="del">Elimina studente</button></p>
         <p><strong>Voto:</strong></p>
         <p> <input type="number" minlength="10" maxlength="10" id="voto" class="form-control" name="voto"></p>
         <p><button type="submit" class="btn btn-primary" value="1" name="lau" id="lau">Laurea studente</button></p>
